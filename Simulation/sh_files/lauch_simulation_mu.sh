...
#SBATCH --job-name=mu_500MeV_no_mPMTs                   # Job name
#SBATCH --output=mu_500MeV_no_mPMTs%j.log             # Standard output and error log
...
$bin_path/WCSim \
    /sps/t2k/eleblevec/WCSimPackage/Simulation/mac_files/hk/mu500MeV_hk.mac \
