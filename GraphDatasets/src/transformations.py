...
"""
This file should contain (ONLY) all the callables (i.e python functions or class with a __call__ attribut) 
used for creating graph datasets.

"""

# À FAIRE : 
# 30/01 :  DONE - Ajouter une erreur si les tailles de feat/label_norm et du nombre de features dans data.x/y ne correspondent pas
